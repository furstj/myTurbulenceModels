...
Moreover, the boundary condition for the variable `Ar` at the wall must be set to [`roughnessAmplification`](../BoCos/roughnessAmplification.qmd) for `Kozulovic2022` or `Langel2017a` models, or to [`roughnessAmplificationLangel`](../BoCos/roughnessAmplificationLangel.qmd) for the `Langel2017` model.
