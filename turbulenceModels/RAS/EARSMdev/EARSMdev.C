...
tmp<volScalarField> EARSMdev<BasicTurbulenceModel>::fMix
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> EARSMdev<BasicTurbulenceModel>::Pk
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> EARSMdev<BasicTurbulenceModel>::epsilonByk
(
...
template<class BasicTurbulenceModel>
void EARSMdev<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
volScalarField EARSMdev<BasicTurbulenceModel>::N
(
...
template<class BasicTurbulenceModel>
void EARSMdev<BasicTurbulenceModel>::correctNonlinearStress(const volTensorField& gradU)
{
    volScalarField tau(
        max
        (
...
template<class BasicTurbulenceModel>
EARSMdev<BasicTurbulenceModel>::EARSMdev
(
...
template<class BasicTurbulenceModel>
bool EARSMdev<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void EARSMdev<BasicTurbulenceModel>::validate()
{
    this->correctNut();
}
...
template<class BasicTurbulenceModel>
void EARSMdev<BasicTurbulenceModel>::correct()
{
