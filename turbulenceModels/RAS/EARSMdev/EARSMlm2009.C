...
EARSMlm2009<BasicTurbulenceModel>::EARSMlm2009
(
...
:
    EARSMBase<kOmegaSSTLM<BasicTurbulenceModel>>
    (
        alpha,
        rho,
        U,
...
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSMlm2009<BasicTurbulenceModel>::F1
(
...
template<class BasicTurbulenceModel>
bool EARSMlm2009<BasicTurbulenceModel>::read()
{
    return EARSMBase<kOmegaSSTLM<BasicTurbulenceModel>>::read(typeName);
}
