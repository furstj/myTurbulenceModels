...
tmp<volScalarField> EARSM<BasicTurbulenceModel>::fv(const volScalarField& Ret) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::fINT() const
{
    return tmp<volScalarField>(new volScalarField(
        "fINT",
        (
...
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::fSS(const volScalarField& W) const
{
    return tmp<volScalarField>(new volScalarField(
        "fSS",
...
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::Cmu(const volScalarField& S) const
{
    return tmp<volScalarField>(new volScalarField(
        "Cmu",
...
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::betaTS(const volScalarField& ReW) const
{
    return tmp<volScalarField>(new volScalarField(
            "betaTS",
...
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::lambdaT() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::lambdaEff(const volScalarField& lambdaT) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::fTaul
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::alphaT
(
    const volScalarField& lambdaEff,
...
/*
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::fOmega
(
    const volScalarField& lambdaEff,
...
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::phiBP(const volScalarField& W) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::phiNAT
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::D(const volScalarField& k) const
{
    return 2.0*this->nu()*magSqr(fvc::grad(sqrt(k)));
}

template<class BasicTurbulenceModel>
tmp<volScalarField> EARSM<BasicTurbulenceModel>::F1() const
{
